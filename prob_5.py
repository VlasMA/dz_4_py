...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("file_one.txt", create_str(koef1))
write_file("file_two.txt", create_str(koef2))

# нахождение суммы многочлена

with open('file_one.txt', 'r') as data:
    st1 = data.readlines()
with open('file_two.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("file_sum.txt", create_str(lst_new))
with open('file_sum.txt', 'r') as data:
    st3 = data.readlines()
